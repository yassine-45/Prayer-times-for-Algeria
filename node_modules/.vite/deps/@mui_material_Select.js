import "./chunk-XTMZ7BO3.js";
import {
  ListContext_default,
  Transition_default,
  useEnhancedEffect_default as useEnhancedEffect_default2,
  useForkRef_default
} from "./chunk-WJAI7FXC.js";
import {
  formControlState
...
import {
  Paper_default
} from "./chunk-RUXA3LLV.js";
import {
  memoTheme_default
} from "./chunk-63BJMMUB.js";
import {
  isFilled
} from "./chunk-HS5A3ZNM.js";
import {
  FormControlContext_default,
  useFormControl
} from "./chunk-ZIX6N57Q.js";
import {
  capitalize_default
} from "./chunk-IEZIIKIU.js";
import {
  globalCss
} from "./chunk-BHJJZZ2N.js";
import {
  useTheme
} from "./chunk-F63PA5VD.js";
import {
  HTMLElementType,
...
var MenuList = React4.forwardRef(function MenuList2(props, ref) {
  ...
  const items = React4.Children.map(children, (child, index) => {
  ...
  return (0, import_jsx_runtime4.jsx)(List_default, {
    role: "menu",
    ref: handleRef,
    className,
...
var Portal = React7.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React7.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React7.isValidElement(children)) {
      ...
      return React7.cloneElement(children, newProps);
    }
...
var Fade = React8.forwardRef(function Fade2(props, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(TransitionComponent, {
    appear,
    in: inProp,
...
var Backdrop = React9.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsx)(TransitionSlot, {
    in: open,
    timeout: transitionDuration,
    ...other,
    ...transitionPropsRemoved,
    children: (0, import_jsx_runtime9.jsx)(RootSlot, {
      "aria-hidden": true,
      ...rootProps,
      classes,
      ref,
...
var Modal = React11.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsx)(Portal_default, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime10.jsxs)(RootSlot, {
      ...rootProps,
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime10.jsx)(BackdropSlot, {
        ...backdropProps,
        ref: backdropRef
      }) : null, (0, import_jsx_runtime10.jsx)(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
var Popover = React12.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(RootSlot, {
    ...
    children: (0, import_jsx_runtime11.jsx)(TransitionComponent, {
      ...
      timeout: transitionDuration,
      ...TransitionProps,
      children: (0, import_jsx_runtime11.jsx)(PaperSlot, {
        ...paperProps,
        ref: handlePaperRef,
        children
      })
...
var Menu = React13.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(MenuRoot, {
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime12.jsx)(MenuMenuList, {
...
var NativeSelectInput = React14.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime13.jsxs)(React14.Fragment, {
    children: [(0, import_jsx_runtime13.jsx)(NativeSelectSelect, {
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref,
      ...other
    }), props.multiple ? null : (0, import_jsx_runtime13.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React15.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime14.jsxs)(React15.Fragment, {
    children: [(0, import_jsx_runtime14.jsx)(SelectSelect, {
      as: "div",
    ...
    }), (0, import_jsx_runtime14.jsx)(SelectNativeInput, {
      "aria-invalid": error,
      ...
      ...other,
      ownerState
    }), (0, import_jsx_runtime14.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime14.jsx)(Menu_default, {
      id: `menu-${name || ""}`,
...
var TextareaAutosize = React17.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const heightRef = React17.useRef(null);
  const shadowRef = React17.useRef(null);
  const calculateTextareaStyles = React17.useCallback(() => {
...
function NotchedOutline(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(NotchedOutlineRoot, {
    "aria-hidden": true,
    className,
    ownerState,
    ...other,
...
var OutlinedInput = React22.forwardRef(function OutlinedInput2(inProps, ref) {
  var _React$Fragment;
  const props = useDefaultProps({
    props: inProps,
    name: "MuiOutlinedInput"
  ...
  return (0, import_jsx_runtime21.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime21.jsx)(NotchedOutlineRoot2, {
      ownerState,
      className: classes.notchedOutline,
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime21.jsxs)(React22.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var Select = React23.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime22.jsx)(React23.Fragment, {
    children: React23.cloneElement(InputComponent, {
