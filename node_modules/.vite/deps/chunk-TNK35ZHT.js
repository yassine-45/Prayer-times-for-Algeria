...
function createGrid(options = {}) {
  ...
  const Grid2 = React12.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime4.jsx)(GridRoot, {
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ...
      children: React12.Children.map(children, (child) => {
        var _a;
        if (React12.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
var elementTypeAcceptingRef_default = chainPropTypes(import_prop_types13.default.elementType, elementTypeAcceptingRef);
...
function useControlled({
  ...
  } = React19.useRef(controlled !== void 0);
...
true ? RtlProvider.propTypes = {
  ...
  value: import_prop_types16.default.bool
} : void 0;
var useRtl = () => {
...
var PropsContext = React32.createContext(void 0);
...
function useDefaultProps({
  ...
  const ctx = React32.useContext(PropsContext);
...
function useCurrentColorScheme(options) {
  ...
  const [, setHasMounted] = React35.useState(false);
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React36.useContext(ColorSchemeContext) || defaultContext;
  function CssVarsProvider(props) {
    ...
    const initialTheme = React36.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React36.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const element = (0, import_jsx_runtime13.jsxs)(React36.Fragment, {
      children: [(0, import_jsx_runtime13.jsx)(ThemeProvider_default2, {
        themeId: scopedTheme ? themeId : void 0,
        theme: resolveTheme ? resolveTheme(theme) : theme,
        children
      }), shouldGenerateStyleSheet && (0, import_jsx_runtime13.jsx)(GlobalStyles, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TNK35ZHT.js.map
